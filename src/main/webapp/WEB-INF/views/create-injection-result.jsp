...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/InjectionResult.css">
</head>
<body>
	...
	<div class="container-fluid ">
		...
		<div class="row">
			...
			<div class="col-sm-9 bg-light right">
				<h1 class="h5 mt-3 text-center text-secondary font-weight-bold mb-3">CREATE
					INJECTION RESULT</h1>
				<div class="h4 text-success font-weight-bold ml-3">${success}</div>
				<div class="card mx-3">
					<div class="card-body">
						<form:form
							action="${pageContext.request.contextPath}/add/injection-result"
							method="post" modelAttribute="injectionResult" id="IR-form">
							<div class="row m-4">
								<div class="col-sm-4 form-group">
									...
									<form:select path="id" id="id" class="form-control">
										...
										<c:forEach items="${customer}" var="cus">
											<option
												value="<%--${cus.fullName}-${cus.dateOfBirth}--%>${cus.id}"
												label="<%--${cus.fullName}-${cus.dateOfBirth}--%>${cus}" />
										</c:forEach>
									</form:select>
								...
								<div class="col-sm-4 form-group">
									...
									<span class="text-danger">(*):</span>
									<form:select path="prevention" id="prevention"
										class="form-control">
								...
								<div class="col-sm-4 form-group">
									<label class="font-weight-bold" for="vaccineType">Vaccine
							...
							<div class="row m-4">
								<div class="col-sm-4 form-group">
									...
									<form:input type="text" class="form-control" placeholder=""
										id="injection" path="numberOfInjection"
										value="${injectionResult.numberOfInjection}" />
									<form:errors path="numberOfInjection"></form:errors>
								</div>
								<div class="col-sm-4 form-group">
									<label class="font-weight-bold" for="dateOfInjection">Date
										of injection:</label>
									<form:input type="date" class="form-control" placeholder=""
										id="dateOfInjection" path="injectionDate"
										value="${injectionResult.injectionDate}" />
									<form:errors path="injectionDate"></form:errors>
								</div>
								<div class="col-sm-4 form-group">
									<label class="font-weight-bold" for="nextOfInjection">Next
										injection appoinment:</label>
									<form:input type="date" class="form-control" placeholder=""
										id="nextOfInjection" path="nextInjectionDate"
							...
							<div class="row m-4">
								<div class="col-sm-4 form-group">
									<label class="font-weight-bold" for="placeOfinjection">Place
										of injection:</label>
									<form:input type="text" class="form-control"
										placeholder="--Select place of injection--"
	...
	<script
		src="${pageContext.request.contextPath}/js/ValidateInjectionResult.js"></script>
	<script
