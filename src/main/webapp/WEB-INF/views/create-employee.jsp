...
<div class="container-fluid ">
    ...
    <div class="row">
        ...
        <div class="col-sm-9 bg-light right">
            <div class="h5 mt-3 text-center text-secondary font-weight-bold mb-3">CREATE EMPLOYEE</div>
            <div class="card mx-3">
                <div class="card-body">
        <form:form action="${pageContext.request.contextPath}/add/employee" method="POST" modelAttribute="employee">
        ...
        <div class="row m-4">
            ...
            <div class="col form-group">
                ...
                <form:input type="text" class="form-control" placeholder="00126192" id="id" path="id" value="${employee.id}" />
            </div>

            <div class="col form-group">
                <label for="name"><strong>Employee name:</strong></label>
                <form:input type="text" class="form-control" placeholder="Nguyen Van A" id="name" path="name" value="${Employee.name}" />
            </div>
        ...
        <div class="row m-4">
            <div class="col form-group">
                ...
                <form:input type="date" class="form-control" placeholder="12/12/1999" id="DoB" path="DoB" value="${Employee.DoB}" />
            </div>
            <div class="col form-group">
                <label for="phone"><strong>Phone:</strong></label>
                <form:input type="phone" class="form-control" placeholder="Doctor" id="phone" path="phone" value="${Employee.phone}" />
            </div>

            <div class="col form-group">
                <label for="id"><strong>Address:</strong></label>
                <form:input type="text" class="form-control" placeholder="17 Duy Tan" id="address" path="address" value="${Employee.address}" />
            </div>
        </div>
        ...
        <div class="row m-4">
            ...
            <div class="col form-group">
                ...
                <form:input type="email" class="form-control" placeholder="nguyena@email.com" id="email" path="email" value="${Employee.email}" />
            </div>

            <div class="col form-group">
                <label for="place"><strong>Working Place:</strong></label>
                <form:input type="text" class="form-control" placeholder="Hong Ngoc" id="place" path="place" value="${Employee.workingPlace}" />
            </div>

            <div class="col form-group">
                <label for="position"><strong>Position:</strong></label>
                <form:input type="text" class="form-control" placeholder="Doctor" id="position" path="position" value="${Employee.position}" />
            </div>
