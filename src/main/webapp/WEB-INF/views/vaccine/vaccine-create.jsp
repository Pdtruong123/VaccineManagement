...
<body>
	...
	<div class="h5 mt-3 text-center text-secondary font-weight-bold mb-3">CREATE
		VACCINE</div>
			...
			<c:if test="${empty vaccineUpdate.id}">
				<form:form action="${pageContext.request.contextPath}/vaccine/add"
					...
					<div class="mt-5">
						...
						<a class="btn btn-sm btn-warning ml-2" href="${pageContext.request.contextPath}/vaccine/import">Import Vaccine</a>
					</div>
