                ...
                <div class="form-row mt-2">
                    <div class="form-group col-sm-4">
                        ...
                        <div class="form-inline">
                            <input type="text" class="form-control w-75" placeholder="Enter name" name="fullName" id="fullName" value="${param.fullName}">
                        </div>
                    </div>
                    <div class="form-group col-sm-4">
                        <label class="font-weight-bold" for="address">Address: </label>
                        <div class="form-inline">
                            <input type="text" class="form-control w-75" placeholder="Enter address" name="address" id="address" value="${param.address}">
                        </div>
                    </div>
