...
<div class="list-group list-group-flush">
    <div class="list-group-item text-white profile">
        ...
        <div class="mt-1"><Strong><%= request.getSession().getAttribute("roleNames") %>
        </Strong></div>
        <div class="row">
            <div class="mt-1 col-sm-6"><%= request.getSession().getAttribute("emailLogin") %>
            </div>
            <div class="col-sm-4"></div>
            <a href="${pageContext.request.contextPath}/logout" class="col-sm-2 text-white" data-toggle="tooltip"
               title="Logout">
    ...
    <div class="menu">
        <div class="list-group-item text font-weight-bold act ">
            <a class='text-decoration-none text-dark ' id="design1"
        ...
        <security:authorize access="hasAuthority('ADMIN')">
                ...
                <div class="mt-3 collapse" id="employee" data-parent="#accordion">
                    <div class="ml-4 text-sub">
                        <a class="text-reset text-decoration-none "
                           href="${pageContext.request.contextPath}/employee/list"> <span
                                class="ml-2">Employee List</span>
                        </a>
                    </div>
                    <div class="ml-4 mt-2 text-sub">
                        <a class="text-reset text-decoration-none "
                           href="${pageContext.request.contextPath}/employee/add"> <span
            ...
            <div class="list-group-item">
                <div class="row text act" data-toggle="collapse"
                    ...
                    <div class="col-sm-10 font-weight-bold " id="design3">Customer
                        Management
                    </div>
                    <div class="col-sm-2">
                        <i class="fa-solid fa-plus"></i>
                ...
                <div class="mt-3 collapse" id="customer" data-parent="#accordion">
                    ...
                    <div class="ml-4 mt-2 text-sub">
                        <a class="text-reset text-decoration-none "
                           href="${pageContext.request.contextPath}/customer/add"> <span
            ...
            <div class="list-group-item">
                <div class="row text act" data-toggle="collapse"
                     data-target="#vaccineType1">
                    <div class="col-sm-10 font-weight-bold " id="design4">Vaccine
                        Type Management
                    </div>
                    <div class="col-sm-2">
                        <i class="fa-solid fa-plus"></i>
                ...
                <div class="mt-3 collapse" id="vaccineType1"
                     data-parent="#accordion">
                    <div class="ml-4 text-sub">
                        <a class="text-reset text-decoration-none"
                           href="${pageContext.request.contextPath}/vaccineType/list"> <span
                                class="ml-2">Vaccine Type List</span>
                        </a>
                    </div>
                    <div class="ml-4 mt-2 text-sub">
                        <a class="text-reset text-decoration-none"
                           href="${pageContext.request.contextPath}/vaccineType/add"> <span
                                class="ml-2">Create Vaccine Type</span>
                        </a>
                    </div>
                </div>
            </div>
            <div class="list-group-item">
                <div class="row text act" data-toggle="collapse"
                     data-target="#vaccine">
                    <div class="col-sm-10 font-weight-bold " id="design5">Vaccine
                        Management
                    </div>
                    <div class="col-sm-2">
                        <i class="fa-solid fa-plus"></i>
        ...
        <security:authorize access="hasAuthority('ADMIN')">
            <div class="list-group-item">
                <div class="row text act" data-toggle="collapse"
                     data-target="#inject">
                    <div class="col-sm-10 font-weight-bold " id="design6">Injection
                        Schedule
                    </div>
                    <div class="col-sm-2">
                        <i class="fa-solid fa-plus"></i>
                ...
                <div class="mt-3 collapse" id="inject" data-parent="#accordion">
                    <div class="ml-4 text-sub">
                        <a class="text-reset text-decoration-none "
                           href="${pageContext.request.contextPath}/injection-schedule/list">
                    ...
                    <div class="ml-4 mt-2 text-sub">
                        <a class="text-reset text-decoration-none "
                           href="${pageContext.request.contextPath}/injectionSchedule/add">
        ...
        <div class="list-group-item">
            <div class="row text act" data-toggle="collapse"
                ...
                <div class="col-sm-10 font-weight-bold " id="design7">Injection
                    Result
                </div>
                <div class="col-sm-2">
                    <i class="fa-solid fa-plus"></i>
        ...
        <div class="list-group-item">
            ...
            <div class="mt-3 collapse" id="news" data-parent="#accordion">
                <div class="ml-4 text-sub">
                    <a class="text-reset text-decoration-none "
                       href="${pageContext.request.contextPath}/news/list"> <span
                ...
                <security:authorize access="hasAuthority('ADMIN')">
                    <div class="ml-4 mt-2 text-sub">
                        <a class="text-reset text-decoration-none "
                           href="${pageContext.request.contextPath}/news/add"> <span
        ...
        <security:authorize access="hasAuthority('ADMIN')">
            <div class="list-group-item">
                ...
                <div class="mt-3 collapse" id="report" data-parent="#accordion">
                    <div class="ml-4 text-sub">
                        <a class="text-reset text-decoration-none "
                           href="${pageContext.request.contextPath}/report/customer"> <span
                                class="ml-2">Report Customer</span>
                        </a>
                    </div>
                    <div class="ml-4 mt-2 text-sub">
                        <a class="text-reset text-decoration-none"
                           href="${pageContext.request.contextPath}/report/vaccine"> <span
                                class="ml-2">Report Vaccine</span>
                        </a>
                    </div>
                    <div class="ml-4 mt-2 text-sub">
                        <a class="text-reset text-decoration-none"
                           href="${pageContext.request.contextPath}/report/injection-result">
