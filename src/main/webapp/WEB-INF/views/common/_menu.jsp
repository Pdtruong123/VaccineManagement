		...
		<security:authorize access="hasAuthority('ADMIN')">
			...
			<div class="list-group-item">
				...
				<div class="mt-3 collapse" id="customer" data-parent="#accordion">
					<div class="ml-4 text-sub">
						<a class="text-reset text-decoration-none " href="${pageContext.request.contextPath}/customer/list"> <span
							class="ml-2">Customer List</span>
						</a>
					</div>
					<div class="ml-4 mt-2 text-sub">
						<a class="text-reset text-decoration-none " href="${pageContext.request.contextPath}/customer/add"> <span
		...
		<security:authorize access="hasAuthority('ADMIN')">
			<div class="list-group-item">
				...
				<div class="mt-3 collapse" id="inject" data-parent="#accordion">
					...
					<div class="ml-4 mt-2 text-sub">
						<a class="text-reset text-decoration-none "
							href="${pageContext.request.contextPath}/injection-schedule/add">
